...
<body>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Sathie, Vadodara.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Sathie, accessible from <a href="https://www.sathie.in"
                    rel="external nofollow noopener" target="_blank">https://www.sathie.in</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>By email:
            <a href="mailto:business@sathie.in"> business@sathie.in
            </a>
        </li>
    </ul>
</body>
