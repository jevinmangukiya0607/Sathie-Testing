            ...
            <div class="panel-collapse">
                <div class="panel-body">
                    ...
                    <div class='row_accord'><label>
                        ...
                        <input type='Text' name='sum_insured' maxLength='75' value='' id='sum_insured' />
                    </div>    
                    ...
                    <div class='row_accord'><label>
                        ...
                        <input type='Text' name='height' maxLength='75' value='' id='height' />
                    </div>

                    <div class='row_accord'><label>
                            Weight
                        </label>
                        <input type='Text' name='weight' maxLength='75' value='' id='height' />
                    </div>
                    ...
                    <div class='row_accord'><label>
                        ...
                        <input type='Text' name='disease' maxLength='75' value='' id='disease' />
                    </div>
                    ...
                    <div class='row_accord'>
                        ...
                        <input type='file' name='policy' maxLength='75' value='' id='policy'
                            accept="image/png, image/jpg, image/jpeg" />
                    </div>
                </div>
            </div>
