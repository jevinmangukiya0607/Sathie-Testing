            ...
            <div class="panel-collapse">
                <div class="panel-body">
                    ...
                    <div class='row_accord'><label>
                        ...
                        <input type='file' name='last_year_policy' maxLength='75'  id='last_year_policy' />
                    </div>

                    <div class='row_accord'><label>
                            RC
                        </label>
                        <input type='Text' name='rc' maxLength='75' value='' id='rc' />
                    </div>

                    <div class='row_accord'><label>
                        Claim Confirmation
                        </label>
                        <input type='Text' name='claim_information' maxLength='75' value='' id='claim_information' />
                    </div>    
