...
@section('content')
<form id="frmFeeParams" method="post" autocomplete="off" action="{{ url('accoutant') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <input type="hidden" name="category_id" value="{{ $category }}"> 
    <input type="hidden" name="subcategory_id" value="{{ $sub_category }}"> 
        ...
        <div class="panel panel-default">
            <div class="panel-heading heading_active">
                <h4 class="panel-title">
                    Provide details for service Accoutant
                </h4>
            </div>
