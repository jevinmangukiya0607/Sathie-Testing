...
<!-- header  -->
    ...
    <section id="service-data" class="service-data-container">
        ...
        <div class="service-input-container">
            <form name="accountant" id="accountant" action="{{ url('banker') }}" method="post" >
                {{ csrf_field() }}
            ...
            <div class="type-of-service input-item">
                ...
                <div class="input-item-data">
                    <select class="" aria-label="Select Category" required id="category" name="category" placeholder="Select">
